...
export const SPECIALES: Entity[] = [
  // --- ARLEQUINS ---
  {
    ...
    modifiers: [
      ...
      // Card Effects (Valeurs Fixes - Pas de scaling 'effect_booster' car c'est un core mechanic)
      // SPADE (Dmg)
      { id: 'arl_s_rat', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_dmg', value: '0.2', toggleId: 'card_spade', toggleGroup: 'arlequin_card', name: 'Ratio Pique (+0.2)' },
      
      // CLUB (Spd)
      { id: 'arl_c_rat', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_spd', value: '0.2', toggleId: 'card_club', toggleGroup: 'arlequin_card', name: 'Ratio Trèfle (+0.2)' },
      
      // HEART (Vit)
      { id: 'arl_h_rat', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_vit', value: '0.2', toggleId: 'card_heart', toggleGroup: 'arlequin_card', name: 'Ratio Coeur (+0.2)' },
      
      // DIAMOND (All Stats 20%)
      { id: 'arl_d_rd', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_dmg', value: '0.2', toggleId: 'card_diamond', toggleGroup: 'arlequin_card', name: 'Ratio Carreau (+0.2)' },
      { id: 'arl_d_rs', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_spd', value: '0.2', toggleId: 'card_diamond', toggleGroup: 'arlequin_card', name: 'Ratio Carreau (+0.2)' },
      { id: 'arl_d_rv', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_vit', value: '0.2', toggleId: 'card_diamond', toggleGroup: 'arlequin_card', name: 'Ratio Carreau (+0.2)' },
      
      // ROYAL (All Stats 50%)
      { id: 'arl_r_rv', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_vit', value: '0.5', toggleId: 'card_royal', toggleGroup: 'arlequin_card', name: 'Ratio Royal (+0.5)' },
      { id: 'arl_r_rs', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_spd', value: '0.5', toggleId: 'card_royal', toggleGroup: 'arlequin_card', name: 'Ratio Royal (+0.5)' },
      { id: 'arl_r_rd', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_dmg', value: '0.5', toggleId: 'card_royal', toggleGroup: 'arlequin_card', name: 'Ratio Royal (+0.5)' },
      { id: 'arl_r_rc', type: ModifierType.FLAT, targetStatKey: 'ratio_deck_crit', value: '0.5', toggleId: 'card_royal', toggleGroup: 'arlequin_card', name: 'Ratio Royal (+0.5)' },
    ]
  },
  {
  ...
  },
  {
    ...
    name: 'Cri de guerre',
    parentId: 'virtuoses',
    description: "Si vous possédez au moins 4 partitions et un instrument à percussions, vous gagnez +60% ^^ +{{(60 * ((effect_booster || 0)/100 + (special_mastery || 0)/100))}}% ^^ Vitalité et Dégâts.",
    modifiers: [
        { 
            id: 'spec_cg_vit', 
            type: ModifierType.PERCENT_ADD, 
            ...
            condition: "(countItems('Instrument (Percussion)') > 0 || countItems('Instrument (Multi-type)') > 0) && countItems('partition') >= 4",
            name: "Bonus Cri de Guerre (Vit)"
        },
        { 
            id: 'spec_cg_dmg', 
            type: ModifierType.PERCENT_ADD, 
